...
T%o combine these two seemingly disconnected threads of research, the results for SAR are extended to POLSAR,
%  since the thesis also shows that the POLSAR models are a generic multi-dimensional superset of the traditional SAR data. %***IVM I changed "ver%sion" to "superset" in the sentence above. Please check if you are comfortable with that change, and if not, change it back!
