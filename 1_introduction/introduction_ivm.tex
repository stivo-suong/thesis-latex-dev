...
contrast in digital image processing. %***IVM Hai I removed "universal". Do you mean "common" or "ubiquitous"?
%***IVM Hai, I don't think this next sentence adds anything
%This is important for the foreseeable future as the enormous size of these data sets will ensure the important roles of digital and computational algorithms in (POL)SAR data processing.
...
This is due to a number of reasons, for example the prevalence of the normal distribution which results from the central limit theorem, or the prevalence of the additive noise model which probably arises due to the linear and additive nature of digital data.%****IVM I'm not sure about this - you seem to assume (in this sentence) that digital data is linear and additive. However this is definitely not true - your POLSAR data is digital and yet is not additive. Maybe you can say "or the prevalence of AWGN in the majority of sensing or sampling systems, and electronic devices."
...
%****IVM, Hai I think you haven't introduced the abbreviation OLS.
...
With this approach, it is important to establish here again the focused problem statement of this thesis.
Thus
                this thesis focuses on providing a solution for the
                dual-problem of: 1) figuring out scalar and
                representative statistical models for the
...
The theoretical foundation is the commonly agreed Circular Complex Normal distributions proposed by Goodman. %***IVM you need a reference here!!
...
To combine these two seemingly disconnected threads of research, the above results for SAR are extended to POLSAR,
  since it is shown that the POLSAR models are a generic multi-dimensional superset of the traditional SAR data.%***IVM I changed "version" to "superset" in the sentence above. Please check if you are comfortable with that change, and if not, change it back!
...
%***IVM maybe this is better: "a straightforward binary evaluation would be sufficient."
For
