...
This restricts the use of the models to a class of problems where a single scalar decision, ranking, sorting or classification answer is required from the complex dataset.
They, however, are the most practical way to answer some commonly asked questions such as:
