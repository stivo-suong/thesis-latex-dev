...
\replyToComment
    ...
    {This has been done.}
%**IVM better not use humour... not all examiners have a sense of humour!!    {Search and replace operation done!}
...
\replyToComment
    ...
    {
      It is true. In fact, the thesis does say that log-transformation will introduce bias. %**IVM
...
%**IVM: I would skip this-> I am amazed by the fact that the Examiner is able to precisely summarize the long thesis into a single sentence.
