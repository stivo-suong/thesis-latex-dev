...
\replyToComment
    ...
    {
     To persuade people into believing its proposed models, the thesis follows rigorous scientific methodologies. 
     They include theoretical mathematics transformations and realistic hypothesis-testing experiments.
      The thesis also includes a chapter detailing several different applications of the proposed models.
      These applications, due to the various practical constraint, are unlikely to be exhaustive over all future applications.

In fact, the two topics of 1) what else the proposed models can be applied on and 2) if the proposed models are to be taken as true, I feel, are not much related.
