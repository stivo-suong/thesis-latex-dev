...
Presented in the figure \ref{fig:k_mle_filtering_power} is the result of a k-MLE filter configured in a $3\times3$ window with 25\% threshold-value, being applied iteratively for four times. 
...
%For comparison, the two schemesâ€™ histogram are plotted in the same figure.
...
use of this consistency. Experimental results suggest that the estimatorâ output also
