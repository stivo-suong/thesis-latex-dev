...
%****IVM: Hai, by "natural coverage" above do you mean non-built-up areas, or are you using this as a figure of speech?  Note: this sentence needs additional correction to include the word 'confidence'.. I'll do that once you can confirm the meaning of 'natural coverage'.
...
\begin{tabular}{c}
	...
	\subfloat[AIRSAR (HH) change ratio]{
          \plotWithLegend{../images/verify_change_ratio_model_on_AIRSAR_1d.eps}
%		 \epsfxsize=1.5in
%		 \epsfysize=1.5in
...
\plotWithLegend{../images/verify_change_ratio_model_on_RADARSAT2_1d.eps}
%		 \epsfxsize=1.5in
%		 \epsfysize=1.5in
...
\begin{tabular}{c}
	...
	\subfloat[AIRSAR (HH-HV) change ratio]{
          \plotWithLegend{../images/verify_change_ratio_model_on_AIRSAR_2d.eps}
%		 \epsfxsize=1.5in
%		 \epsfysize=1.5in
%		 \epsffile{../images/verify_change_ratio_model_on_AIRSAR_2d.eps} 	
	...
	\subfloat[RADARSAT2 (HH-HV) change ratio]{
          \plotWithLegend{../images/verify_change_ratio_model_on_RADARSAT2_2d.eps}
...
\begin{tabular}{c}
	...
	\subfloat[AIRSAR (HH-HV-VV) change ratio]{
          \plotWithLegend{../images/verify_change_ratio_model_on_AIRSAR_3d.eps}
%		 \epsfxsize=1.5in
%		 \epsfysize=1.5in
%		 \epsffile{../images/verify_change_ratio_model_on_AIRSAR_3d.eps} 	
	...
	\subfloat[RADARSAT2 (HH-HV-VV) change ratio]{
          \plotWithLegend{../images/verify_change_ratio_model_on_RADARSAT2_3d.eps}
%          \begin{pspicture}[showgrid=false](\column,\row)% set showgrid=false for the final
