...
\begin{abstract}
  ...
  %The paper also illustrates a couple of benefits of these models, specifically for using the homoskedastic discrimination measures.
  %A couple of benefits for using these homoskedastic dis-similarity measures are then illustrated in this paper.
  %These homoskedastic measures of distance
