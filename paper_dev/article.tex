...
While several multidimensional models have been proposed for the POLSAR data,
...
The applicability of these theoretical models is illustrated by experiments where the specific one, two and three dimensional versions of the proposed generic models are validated against practical data. 
...
Thus, the rest of this article is organized as follows.
...
Statistical models have always been the foundation to derive discrimination measures.
...
For POLSAR, where the field is much less matured,
  the same case should apply, 
  except that so far only asymptotic distribution has been derived for the most common foundation, i.e. the likelihood test statistics \cite{Conradsen_2003_TGRS_4}.
...
This, in essence, derives an exact statistical distribution for the likelyhood test statistics,
