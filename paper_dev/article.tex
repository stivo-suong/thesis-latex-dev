...
This qualitative observation is further supported by high significance level (or p-value) of the standard Kolmogorov–Smirnov goodness-of-fit test.
While a good p-value does not mean automatic acceptance of the model,
  consistently high p-value readings suggest that the proposed model has excellent confidence-limit \cite{Kolmogoroff_1941_AMS_461}.
