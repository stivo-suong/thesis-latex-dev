...
Furthermore, practical POLSAR data processing also makes heavy use of scalar discrimination measures,
  which should be based on statistically consistent (i.e. signal-independent) models. %for scalar and representative observables of the multidimensional data.
...
The approach taken in this paper differs 
  ...
  %by applying the homoskedastic log transformation on 
...
As for the first matter, in view of the models given in Eqn \ref{eqn:determinant_distribution},
  the likelihood test statistics presented in \cite{Conradsen_2003_TGRS_4} and rewritten in Eqn. \ref{eqn:ori_likelyhood_stats} %\& \ref{eqn:log_likelyhood_stats}
can be expressed as:
\begin{align*}
...
It is clear that the model histogram matches the data well
  %, in fact appearing similar to a smoothed data response. 
