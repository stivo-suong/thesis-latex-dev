...
\markboth{IEEE Journal on Selected Topics in Applied Earth Observation and Remote Sensing,~Vol.~x, No.~x, x~2014}%
...
This, in essence, derives an exact statistical distribution for the likelihood test statistics (as opposed to an asymptotic distribution \cite{{Conradsen_2003_TGRS_4}}).
...
In all cases, the good match between the actual data and model distribution lends support to the proposed model. %providing us a simple validation of the result.
...
The look-number is estimated for each type of data and for each image~\cite{Anfinsen_2009_TGRS_3795}. %and is also noted in the plots.
...
\end{tabular}
\caption{Visual evaluation of POLSAR boxcar 3$\times$3 vs. 5$\times$5 speckle filters on AIRSAR Flevoland part-pol data (HH-HV).}
