...
\newsavebox\IBox
\savebox\IBox{\includegraphics[width=2.5in,height=2.5in]{../images/verify_change_ratio_model_on_RADARSAT2_3d.eps}}
...
\newcommand{\plotWithLegend}[2]{          
	    ...
	    \rput[bl](0,0){\includegraphics[width=2.5in,height=2.5in]{#1}}% \usebox\IBoxCRThreeR
...
$\ddag$ School of Information Science and Technology,
...
There has been a few scalar observables with accompanying statistical models proposal for POLSAR \citep{Conradsen_2003_TGRS_4, Alberga_2008_IJRS_4129, Joughin_1994_TGRS_562, Lee_1994_TGRS_1017, Touzi_1996_TGRS_519, Lopez-Martinez_2003_TGRS_2232, Erten_2012_Sensors_2766},
...
In \citep{Alberga_2008_IJRS_4129}, the performance of different scalar POLSAR observables is evaluated for classification purposes.
...
More recently, statistical models for
  ...
  as well as for the largest eigen-value of the covariance matrix $\lambda_1$ \citep{Erten_2012_Sensors_2766} have been proposed.
...
In the field of POLSAR, the Wishart distance is probably the most widely used, as part of the well-known Wishart classifier \citep{Lee_1999_TGRS}.
It is defined \citep{Lee_1994_IJRS_2299} as:
\begin{equation}
...
The close relation among the measures is further supported by the fact that
  all of their publications refered the same statistical model developed in \citep{Conradsen_2003_TGRS_4} as the foundation.
...
However, in the original work \citep{Conradsen_2003_TGRS_4}, only an asymptotic distribution was used.
...
Goodman \citep{Goodman_1963_AMS_178} proved
...
First, similar to the way that the statistical model for SAR intensity has been used to provide the foundation for SAR discrimination measures, e.g. intensity-ratio \citep{Rignot_1993_TGRS_896},
...
The look-number $L$ can be taken either as nominally stated by the data provider,
  or it can be estimated using the technique proposed by \citep{Anfinsen_2009_TGRS_3795}.
...
The look-number is estimated for each type of data and for each image using the technique described in \citep{Anfinsen_2009_TGRS_3795}. %and is also noted in the plots.
...
%		 \epsffile{../images/verify_det_ratio_model_on_RADARSAT2_3d.eps} 	
		 \label{RADARSAT2_2D_det_ratio}
                \subcaption{RADARSAT2 (HH-HV-VV) determinant ratio}
 \end{minipage}                \\ 
%	} \\
